...
![Bioinformatics](https://img.shields.io/badge/Bioinformatics-Project-success)
![Analysis](https://img.shields.io/badge/Analysis-Protein-orange)
---
...
**Figure 6.** Predicted three-dimensional structure of the human TP53 protein generated by AlphaFold. The structure is coloured according to the predicted Local Distance Difference Test (pLDDT) confidence score, where blue indicates high confidence and orange/red represents intrinsically disordered or flexible regions. Regions with pLDDT values above 90 are considered highly reliable predictions, whereas lower scores generally correspond to intrinsically disordered or flexible protein regions.
...
The analyses presented in this project were performed using publicly available bioinformatics databases and resources. The following references correspond to the primary publications describing these databases.

1. The UniProt Consortium. (2025). **UniProt: the Universal Protein Knowledgebase in 2025.** *Nucleic Acids Research*, **53**(D1), D609–D617.

2. Varadi, M., Anyango, S., Deshpande, M., et al. (2024). **AlphaFold Protein Structure Database in 2024: providing structure coverage for the scientific community.** *Nucleic Acids Research*, **52**(D1), D368–D375.

3. Berman, H. M., Westbrook, J., Feng, Z., et al. (2000). **The Protein Data Bank.** *Nucleic Acids Research*, **28**(1), 235–242.

4. Orchard, S., Ammari, M., Aranda, B., et al. (2014). **The MIntAct project—IntAct as a common curation platform for 11 molecular interaction databases.** *Nucleic Acids Research*, **42**(D1), D358–D363.

5. Szklarczyk, D., Kirsch, R., Koutrouli, M., et al. (2025). **The STRING database in 2025: protein–protein association networks and functional enrichment analyses.** *Nucleic Acids Research*, **53**(D1), D631–D637.

6. Piñero, J., Ramírez-Anguita, J. M., Saüch-Pitarch, J., et al. (2020). **The DisGeNET knowledge platform for disease genomics: 2019 update.** *Nucleic Acids Research*, **48**(D1), D845–D855.

7. Amberger, J. S., Bocchini, C. A., Scott, A. F., & Hamosh, A. (2019). **OMIM.org: leveraging knowledge across phenotype–gene relationships.** *Nucleic Acids Research*, **47**(D1), D1038–D1043.

8. Gillespie, M., Jassal, B., Stephan, R., et al. (2022). **The Reactome pathway knowledgebase 2022.** *Nucleic Acids Research*, **50**(D1), D687–D692.

9. Gene Ontology Consortium. (2023). **The Gene Ontology knowledgebase: 2023 update.** *Genetics*, **224**(1), iyad031.
